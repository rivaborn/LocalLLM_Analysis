...
The `#Subsections begin` / `#Subsections end` block lists subdirectories for `ArchPipeline.py` to process in sequence. Comment lines (e.g. `# 530 files`) are ignored by the parser.
